...
public class Compositor extends Persona {
    ...
    public Compositor(int numeroDeComposiciones, int codigo, String nombre, String apellido, int edad, double salario, Nacionalidad nacionalidad) {
    ...
    public double calularSalario() {
        ...
        if (cancionesTop100Billaboar.size() >= 1 && cancionesTop100Billaboar.size() <= 3) {
            salarioFinal = salarioFinal+ (super.getSalario() * 0.1);
